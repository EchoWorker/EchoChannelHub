...
Connect EchoAI to QQ through the official QQ Bot API. Version 0.1.1 supports C2C private text/image messages and group text/image messages that explicitly mention the bot.
