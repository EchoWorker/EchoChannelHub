...
const version = JSON.parse(fs.readFileSync(path.join(root, "channels", "wechat", "channel.json"), "utf8")).version;
const artifact = path.join(root, "artifacts", `wechat-${version}-${TARGET}.echochannel`);
